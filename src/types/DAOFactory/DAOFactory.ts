...
export class DAOFactory extends SmartContract {
  ...
  try_baseACL(): CallResult<Address> {
    let result = super.tryCall("baseACL", []);
    if (result.reverted) {
  ...
  try_regFactory(): CallResult<Address> {
    let result = super.tryCall("regFactory", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  try_baseKernel(): CallResult<Address> {
    let result = super.tryCall("baseKernel", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  newDAO(_root: Address): Address {
    let result = super.call("newDAO", [EthereumValue.fromAddress(_root)]);

    return result[0].toAddress();
  }

  try_newDAO(_root: Address): CallResult<Address> {
    let result = super.tryCall("newDAO", [EthereumValue.fromAddress(_root)]);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
