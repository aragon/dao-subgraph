...
export class AppProxyUpgradeable extends SmartContract {
  static bind(address: Address): AppProxyUpgradeable {
    return new AppProxyUpgradeable("AppProxyUpgradeable", address);
  }
